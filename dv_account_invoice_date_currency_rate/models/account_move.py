...
class AccountMove(models.Model):
    ...
    def _inverse_amount_total(self):
        for move in self:
            ...
            balance = move.currency_id._convert(
                amount_currency, move.company_currency_id, move.company_id, move.invoice_date)
    ...
    # line.date no ha sido modificado
    ...
    def _recompute_cash_rounding_lines(self):
        ...
        def _compute_cash_rounding(self, total_amount_currency):
            ...
            if self.currency_id == self.company_id.currency_id:
                ...
                diff_balance = self.currency_id._convert(
                    diff_amount_currency, self.company_id.currency_id, self.company_id, self.invoice_date)
        ...
        _apply_cash_rounding(self, diff_balance,
                             diff_amount_currency, existing_cash_rounding_line)
    ...
    def _recompute_tax_lines(self, recompute_tax_base_amount=False, tax_rep_lines_to_recompute=None):
        ...
        for taxes_map_entry in taxes_map.values():
            ...
            tax_base_amount = currency._convert(taxes_map_entry['tax_base_amount'], self.company_currency_id, self.company_id, self.invoice_date or fields.Date.context_today(self))
