...
class AccountDebitNote(models.TransientModel):
    ...
    def default_get(self, fields):
        ...
        debit_journal = self.env['account.journal'].search([('l10n_latam_document_type_id','=',self.env.ref('l10n_pe.document_type08').id)],limit=1)
        if debit_journal:
    ...
    def _prepare_default_values(self, move):
        ...
        default_values['l10n_latam_document_type_id'] = self.env.ref('l10n_pe.document_type08').id
