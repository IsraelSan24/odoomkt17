...
class ResConfigSettings(models.TransientModel):
    ...
    l10n_pe_edi_min_amount_retention = fields.Float(related="company_id.l10n_pe_edi_min_amount_retention", readonly=False)
    l10n_pe_edi_min_amount_detraction = fields.Float(related="company_id.l10n_pe_edi_min_amount_detraction", readonly=False)
    l10n_pe_edi_detraction_bank_account_id = fields.Many2one(related="company_id.l10n_pe_edi_detraction_bank_account_id", readonly=False)
    l10n_pe_edi_detraction_payment_type_id = fields.Many2one(related="company_id.l10n_pe_edi_detraction_payment_type_id", readonly=False)
