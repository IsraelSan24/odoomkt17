...
class EdiRequest(models.Model):
    ...
    sunat_canceled = fields.Boolean('Canceled by SUNAT', compute='compute_request_data', store=True, tracking=True)
    ...
    def compute_request_data(self):
        for req in self:
            ...
            req.sunat_canceled = log_id_ose_accepted and log_id_ose_accepted[0].sunat_canceled or False
...
class L10nPeEdiRequestLog(models.Model):
    ...
    sunat_canceled = fields.Boolean('Canceled by SUNAT')
